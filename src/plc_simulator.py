...
class PLCSimulator:
    def __init__(self):
        ...
        self.CYCLE_TIME = 0.2           # Time interval for cyclic execution [seconds]
    ...
    async def handle_alarms(self):
        ...
        if alarm_id:
            ...
            self.trip = False
            self.digital_outputs[DigitalOutputs.DISCHARGING_GATE_CLOSE] = True # Close the discharging gate
